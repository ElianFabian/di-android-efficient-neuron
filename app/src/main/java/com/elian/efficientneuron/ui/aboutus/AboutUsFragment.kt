...
//        adsElement.setTitle("Advertise with us")
        val aboutPage = AboutPage(context)
            .isRTL(false)
            .setDescription("This application is a project to learn how to create applications on android. It's an exercise from the Android module in IES Portada Alta.")
            //.addItem(adsElement)
